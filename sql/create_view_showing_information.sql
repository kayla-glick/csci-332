...
SELECT shows.id AS showing_id, shows.show_date, shows.show_time, shows.price, movs.title AS movie, movs.run_time, cins.id AS cinema_id, thets.number as theater_number
FROM Showings shows
